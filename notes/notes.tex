...
\begin{equation}
  \Jr(E,L) = \frac{1}{\pi} \int_{\rmin}^{\rmax}\vr(r)\rd r =  \frac{1}{\pi} \int_{\rmin}^{\rmin} \sqrt{2(\psieff(r,L)-E)}\rd r.
...
\begin{equation}
  \Theta(E,L) =   \int_{\rmin}^{\rmax} \frac{2 L \rd r}{r^{2}\sqrt{2(\psieff(r,L)-E)}}.
  \label{eq:Apsidal_angle}
\end{equation}

Those quantities are linked by the relations 
...
\begin{align*}
 D_{r} &= \frac{\partial \Jr}{\partial E} \dE + \frac{\partial \Jr}{\partial L} \dL+\frac{1}{2}\bigg(\frac{\partial^2 \Jr}{\partial E^2} \dEE +2 \frac{\partial^2 \Jr}{\partial E \partial L} \dEL +\frac{\partial^2 \Jr}{\partial L^2} \dLL\bigg) \\
    &= -\frac{T}{2\pi} \dE -\frac{\Theta}{2\pi} \dL+\frac{1}{2}\bigg(\frac{\partial T}{\partial E} \dEE +2 \frac{\partial T}{\partial L} \dEL +\frac{\partial \Theta}{\partial L} \dLL\bigg) \\
