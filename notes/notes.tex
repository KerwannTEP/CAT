...
\newcommand{\tha}{\theta_{\ra}}
\newcommand{\thr}{\theta_{\rr}}
\newcommand{\phia}{\phi_{\ra}}
...
$(\va\sin\tha\cos\phia,\va\sin\tha\sin\phia,\va\cos\tha)$ and $(\sin\thr,0,\cos\thr)= (v/\vt,v/\vr)$, and we have

\begin{equation}
  \begin{array}{ccl}
    \var(r,\va,\theta,\phi) & =& \bv \cdot \hr = \displaystyle{\frac{v\va}{\vt}\sin\tha\cos\phia  + \frac{v\va}{\vr}\cos\tha} , \\

    \vat^2(r,\va,\theta,\phi) &=& \displaystyle{\va^{2} \left[1 - \left(\frac{v}{\vt}\sin\tha\cos\phia  + \frac{v}{\vr}\cos\tha\right)^{2}\right] } ,
...
\begin{equation}
    \La(r,\va,\theta,\phi) = \displaystyle{ r \va \sqrt{1 - \left( \frac{v}{\vr}\cos\tha + \frac{v}{\vt}\sin\tha\cos\phia\right)^{2} }} .
